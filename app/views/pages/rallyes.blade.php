      ...
      <section class="events__next">
          ...
          <ol class="events__next__list">
            ...
            <li class="events__next__list__item">
              <a class="events__next__list__item__link" href="{{ URL::route('showEvent', $next->id) }}">
                ...
                <div class="events__next__list__item__link__infos">
                  ...
                  <span class="events__next__list__item__link__infos__place"><span class="icon-location4"></span>{{$next->town}}</span>
                  <span class="events__next__list__item__link__infos__date"><span class="icon-calendar2"></span>{{strftime("%A %d %B %G", strtotime($next->date))}}</span>
                </div>
              </a>
            </li>
            @endforeach
          ...
          <div class="events__past__wrapper">
            ...
            <ol class="events__past__wrapper__list">
              ...
              <li class="events__past__wrapper__list__item">
                <a class="events__past__wrapper__list__item__link" href="{{ URL::route('showEvent', $last->id) }}">
                  ...
                  <div class="events__past__wrapper__list__item__link__infos">
                    ...
                    <span class="events__past__wrapper__list__item__link__infos__place"><span class="icon-location4"></span>{{$last->town}}</span>
                    <span class="events__past__wrapper__list__item__link__infos__date"><span class="icon-calendar2"></span>{{strftime("%A %d %B %G", strtotime($last->date))}}</span>
                  </div>
                </a>
              </li>
              @endforeach
